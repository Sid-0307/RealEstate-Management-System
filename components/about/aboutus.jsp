...
<body>
    <div class="navbar">
        <ul>
            ...
            <li class="start" id="home"><a href="/components/index/landing.html" >Home</a></li>
            <li class="nav-item"><a href="/components/properties/properties.jsp">Properties</a></li>
            <li class="nav-item"><a href="/components/choice/choice.jsp">Sell</a></li>
            <li class="nav-item" id="active"><a href="/components/about/aboutus.jsp">About Us</a></li>
    ...
    <script>
        ...
        if(checklogin.value == "yes")
        {
            home.innerHTML=`<a href="/components/index/account.jsp" >Home</a>`
            checklogin.innerHTML = `<a href="/static/res/logout"><img src="https://static-00.iconduck.com/assets.00/logout-icon-512x512-2x08s84n.png" 
