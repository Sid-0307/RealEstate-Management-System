...
pageEncoding="UTF-8"%> <%@ page import="java.text.*,java.util.*" %>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    ...
    <script>
      function fun2() {
        ...
        document
          ...
          .setAttribute("action", "/static/res/register");
      }
      function fun1() {
        document.getElementById("content").innerHTML = `
                <input type="email" name='username' placeholder="Email" required><br>
        ...
        document
          .getElementById("mainform")
          .setAttribute("action", "/static/res/login");
      }
    </script>
    ...
    <script>
      ...
      console.log(status);
      if (status == "success") swal("Welcome", "Account created!", "success");
