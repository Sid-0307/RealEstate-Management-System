...
<body>
    <div class="navbar">
        <ul>
            <li class="logo">
            <img src="/static/images/logo.png" alt="" height="50px" width="80px"><span class="website-name"><span class="u">U</span>rban<span class="u">U</span>topia</span>
            </li>
            <li class="start"><a href="/components/index/account.jsp">Home</a></li>
            <li class="nav-item" id="active"><a href="/components/properties/properties.jsp">Properties</a></li>
            <li class="nav-item"><a href="/components/choice/choice.jsp" >Sell</a></li>
            <li class="nav-item"><a href="/components/about/aboutus.jsp">About Us</a></li>
            <li class="nav-item"><a href="/components/contact/contactus.jsp">Contact</a></li>
            <li class="nav-item">
                <a href="/static/res/logout"><img src="https://static-00.iconduck.com/assets.00/logout-icon-512x512-2x08s84n.png" class="login" alt="logout" height="40px" width="50px"></a>
            </li>
        </ul>
    <form action="/static/res/properties" method="post">
        <div class="search">
            ...
            <button><img src="/static/images/search.jpg" class="search-img" width="65px" height="65px" alt=""></button>
        </div>
    </div>
    <div class="main">
        <div class="filter">
