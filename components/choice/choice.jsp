...
<html lang="en">
  ...
  <body>
    <input type="hidden" id="newp" value="<%=
    request.getAttribute("new_property") %>">
    <div class="navbar">
      <ul>
        <li class="logo">
          <img
        ...
        <li class="nav-item">
          <a href="/components/index/landing.html">
            <img
    ...
    <script>
      ...
      if (newp == "success") swal("Success!", "Property added!", "success");
      else if (newp == "failed")
      ...
      function add() {
        ...
        document.getElementById("main").innerHTML = `
        <form action="/static/res/sell" method="post">
            <div class="personal">
      ...
      function addProps(properties) {
        ...
        if (properties[0] === "") {
          ...
          content.innerHTML =
            "You have not added any properties!<br>Go back to add properties..";
