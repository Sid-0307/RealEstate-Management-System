  ...
  <body>
    <div class="navbar">
      <ul>
        ...
        <li class="nav-item login"><a href="/static/res/logout">Logout</a></li>
      </ul>
    </div>
    <div class="main" id="main"></div>
    <input type="hidden" id="getProperty"
    value="<%=request.getAttribute("data_mod") %>">>
  </body>
  ...
  <script>
    ...
    function renderData(properties) {
      ...
      if (properties[0] === "") {
        ...
        content.innerHTML =
          "No properties to be Moderated!<br>Refresh to get new ones..";
      ...
      for (var i = 0; i < properties.length - 1; i++) {
        ...
        console.log(item);
        if (item[3] == 1) t = "Induvidual House";
        if (item[3] == 2) t = "Apartment";
        if (item[3] == 3) t = "Villa";
        if (item[3] == 4) t = "Plot";
        ...
        accept.addEventListener("click", function () {
          ...
          xhr.open("POST", "/static/res/moderator");
        ...
        reject.addEventListener("click", function () {
          const xhr = new XMLHttpRequest();
          xhr.open("POST", "/static/res/moderator"); // Servlet path
          xhr.setRequestHeader(
            "Content-Type",
            "application/x-www-form-urlencoded"
          );
